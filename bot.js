...
client.on("message", message => {
 if (message.content === "-help") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© big community:heart: جميع الحقوق محفوظة 2018 لــبوت')
...
client.on("message", message => {
 if (message.content === "-invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© big community:heart: جميع الحقوق محفوظة 2018 لــبوت')
      .addField('شكرا لك لاستخدامك البةت', `https://discordapp.com/api/oauth2/authorize?client_id=527197798672629761&permissions=8&scope=bot`)
  message.author.send({embed});
